...
@section('title')
{{ $title='Thêm mới quảng cáo box gamemini desktop' }}
@stop
...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ action('AdGameMiniDesktopController@index') }} " class="btn btn-success">Danh sách quảng cáo box gamemini desktop</a>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
			<!-- form start -->
			{{ Form::open(array('action' => array('AdGameMiniDesktopController@update', $advertise->id), 'method' => 'PUT')) }}
			<div class="box-body">
