...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ action('AdGamePlayMobileController@index') }} " class="btn btn-success">Danh sách quảng cáo</a>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
			<!-- form start -->
			{{ Form::open(array('action' => array('AdGamePlayMobileController@update', $ad->id), 'method' => 'PUT')) }}
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-6">	                  	
						   {{ Form::select('position', AdCommon::getPositionClassAd('ad_game_play_mobile'), $ad->position) }}
						</div>
					</div>
				</div>
