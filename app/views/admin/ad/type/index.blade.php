...
<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ action('AdHomeMobileController@create') }}" class="btn btn-primary">Thêm mới quảng cáo box minigame</a>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
	  <div class="box">
		<div class="box-header">
		  <h3 class="box-title">Danh sách quảng cáo box minigame</h3>
		</div>
		<!-- /.box-header -->
