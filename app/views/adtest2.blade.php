...
<div class="box">
	...
	<div class="playgame">
		<div class="playbox">
			...
			<div id="game-container" style="display:none; margin: 10px auto; width: 640px; height: 480px;">
				<iframe name="my-iframe" id="my-iframe" width="100%" src="{{ url('games/pikachu-dong-vat/game.html') }}" height="100%" scrolling="no" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" webkit-playsinline="true" seamless="seamless" style="-webkit-transform: scale(1, 1);
