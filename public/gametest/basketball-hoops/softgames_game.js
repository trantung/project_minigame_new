...
GUI.prototype.zeroPoints = function() {
    this.inRow += U3e.Y3R;
    if(U3e.C2R(this.inRow, U3e.i3R)) this.inRow = U3e.I3R, SG_Hooks.gameOver(this.multiplier, this.pointsNumber);
    createjs.Tween.get(this).to({
...
PauseWindow.prototype.init = function() {
    ...
    this.resumeButton.group.y = 410//U3e.z27;
    this.resumeButton.group.alpha = U3e.I3R;
    this.resumeButton.clickCallback = this.resumeClicked.bind(this);
    
    this.saveButton = new MenuButton(U3e.m57, currLang.savescore);
    this.saveButton.group.x = U3e.A6R(MLE.width, 2);
    this.saveButton.group.y = 520
    this.saveButton.group.alpha = U3e.I3R;
    this.saveButton.clickCallback = this.saveClicked.bind(this);
...
PauseWindow.prototype.update = function() {
    U3e.J6R(this.sprite.alpha, U3e.Y3R) && (this.resumeButton.update(), this.saveButton.update(),this.backToMenuButton.update());
};
...
PauseWindow.prototype.show = function() {
    ...
    createjs.Tween.get(this.saveButton.group).wait(U3e.H3R).to({
        alpha: U3e.Y3R
    }, U3e.O67);
...
PauseWindow.prototype.hide = function() {
    ...
    createjs.Tween.get(this.saveButton.group).to({
        alpha: U3e.I3R
    }, U3e.O67);
...
PauseWindow.prototype.saveClicked = function() {
    
    console.log("luudiem:" + gscore)
	 
};

PauseWindow.prototype.backToMainMenu = function() {
    this.resumeButton.block = U3e.G77;
    this.saveButton.block = U3e.G77;
