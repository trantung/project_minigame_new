    ...
    b.dispatchEvent = function(a, m) {
        ...
        if (a && d) {
            ...
            for (var d = d.slice(), c = 0, f = d.length; c < f; c++) {
                var h = d[c];
                h instanceof Function ? b = b || h.apply(null, [a]) : h.handleEvent &&
                    (b = b || h.handleEvent(a))
            }
        }
        return !!b
...
(function() {
    ...
    c._tick = function() {
        ...
        for (var d = c._pauseable, e = c._listeners.slice(), f = e ? e.length : 0, h = 0; h < f; h++) {
            var j = e[h];
            null == j || b && d[h] || (j.tick ? j.tick(m, b) : j instanceof Function && j(m, b))
        }
        c.dispatchEvent({
            type: "tick",
            paused: b,
...
(function() {
    ...
    b.prependTransform = function(a, b, g, d, e, f, h, j, k) {
        if (e % 360) {
            ...
            e = Math.cos(l);
            l = Math.sin(l)
        } else e = 1, l = 0; if (j || k) this.tx -= j, this.ty -= k;
    ...
    b.appendTransform = function(a, b, g, d, e, f, h, j, k) {
        ...
        if (j || k) this.tx -= j * this.a + k * this.c, this.ty -= j * this.b + k * this.d;
        return this
    };
    b.rotate = function(a) {
        var b = Math.cos(a);
    ...
    b.decompose = function(a) {
        ...
        b == g ? (a.rotation = g / c.DEG_TO_RAD, 0 > this.a && 0 <= this.d && (a.rotation += 0 >= a.rotation ? 180 : -180), a.skewX = a.skewY = 0) : (a.skewX = b / c.DEG_TO_RAD,
            a.skewY = g / c.DEG_TO_RAD);
        return a
    };
...
(function() {
    ...
    b.handleEvent = function(a) {
        var b = this.target,
            g = a.type;
        "mousedown" == g ? (a.addEventListener("mouseup", this), this._isPressed = !0, a = this.downLabel) : "mouseup" == g ? (this._isPressed = !1, a =
            this._isOver ? this.overLabel : this.outLabel) : "mouseover" == g ? (this._isOver = !0, a = this._isPressed ? this.downLabel : this.overLabel) : (this._isOver = !1, a = this._isPressed ? this.overLabel : this.outLabel);
        ...
        if (null != a) {
            ...
            if (null != a.frames)
                if (a.frames instanceof Array) {
                    ...
                    d = a.frames;
                    b = 0;
                    for (g = d.length; b < g; b++) f = d[b], this._frames.push({
    ...
    b._calculateFrames = function() {
        if (!(this._frames || 0 == this._frameWidth)) {
            ...
            for (var a = 0, b = this._frameWidth, g = this._frameHeight, d = 0, c = this._images; d < c.length; d++) {
                for (var f = c[d], h = (f.width + 1) / b | 0, j = (f.height + 1) / g | 0, j = 0 < this._numFrames ? Math.min(this._numFrames - a, h * j) : h * j, k = 0; k < j; k++) this._frames.push({
                    image: f,
                    rect: new createjs.Rectangle(k % h * b, (k / h | 0) * g, b, g),
                    regX: this._regX,
                    regY: this._regY
                });
                a += j
...
(function() {
    ...
    a.drawRoundRectComplex = function(a, b, d, e, f, h, j, k) {
        ...
        var l = this._ctx.arcTo,
            r = this._ctx.lineTo;
        this._activeInstructions.push(new c(this._ctx.moveTo, [a + d - h, b]), new c(l, [a + d + h * p, b - h * p, a + d, b + h, h]), new c(r, [a + d, b + e - j]), new c(l, [a + d + j * q, b + e + j * q, a + d - j, b + e, j]), new c(r, [a + k, b + e]), new c(l, [a - k * s, b + e + k * s, a, b + e - k, k]), new c(r, [a, b + f]), new c(l, [a - f * n, b - f * n, a + f, b, f]), new c(this._ctx.closePath));
        return this
    };
    a.drawCircle =
        function(a, b, d) {
    ...
    a.drawEllipse = function(a, b, d, e) {
        ...
        d = a + d / 2;
        e = b + e / 2;
        this._activeInstructions.push(new c(this._ctx.moveTo, [a, e]), new c(this._ctx.bezierCurveTo, [a, e - h, d - f, b, d, b]), new c(this._ctx.bezierCurveTo, [d + f, b, j, e - h, j, e]), new c(this._ctx.bezierCurveTo, [j, e + h, d + f, k, d, k]), new c(this._ctx.bezierCurveTo, [d - f, k, a, e + h, a, e]));
        return this
    };
    a.drawPolyStar = function(a, b, d, e, f, h) {
        ...
        for (var k = 0; k < e; k++) h += j, 1 != f && this._activeInstructions.push(new c(this._ctx.lineTo, [a + Math.cos(h) * d * f, b + Math.sin(h) * d * f])), h += j, this._activeInstructions.push(new c(this._ctx.lineTo, [a + Math.cos(h) * d, b + Math.sin(h) * d]));
        return this
    };
    a.decodePath = function(a) {
        for (var g = [this.moveTo, this.lineTo, this.quadraticCurveTo, this.bezierCurveTo,
            this.closePath
        ], d = [2, 2, 4, 6, 0], c = 0, f = a.length, h = [], j = 0, k = 0, l = b.BASE_64; c < f;) {
            var n = a.charAt(c),
                p = l[n],
                q = p >> 3,
                s = g[q];
    ...
    a._updateInstructions = function() {
        ...
        this._strokeInstructions && (this._strokeStyleInstructions && this._instructions.push.apply(this._instructions, this._strokeStyleInstructions), this._instructions.push.apply(this._instructions, this._strokeInstructions), this._ignoreScaleStroke ? this._instructions.push(new c(this._ctx.save, [], !1), new c(this._ctx.setTransform, [1, 0, 0, 1, 0, 0], !1), b.strokeCmd, new c(this._ctx.restore, [], !1)) : this._instructions.push(b.strokeCmd))
    };
    a._newPath = function() {
        this._dirty && this._updateInstructions();
...
(function() {
    ...
    b._applyFilters = function() {
        if (this.filters && 0 != this.filters.length && this.cacheCanvas)
            for (var a = this.filters.length, b = this.cacheCanvas.getContext("2d"), c = this.cacheCanvas.width, d = this.cacheCanvas.height, e = 0; e < a; e++) this.filters[e].applyFilter(b, 0, 0, c, d)
    };
...
(function() {
    ...
    b._getObjectsUnderPoint = function(a, b, g, d) {
        ...
        if (!this.hitArea && (this.cacheCanvas && j) && (this.getConcatenatedMatrix(h), e.setTransform(h.a, h.b, h.c, h.d, h.tx - a, h.ty - b), e.globalAlpha = h.alpha, this.draw(e),
            this._testHit(e))) return f.width = 0, f.width = 1, this;
        for (var k = this.children.length - 1; 0 <= k; k--) {
            var l = this.children[k],
                n = l.hitArea;
            if (l.visible && !(!n && !l.isVisible() || d && !l.mouseEnabled)) {
                var p = d && l._hasMouseHandler(d);
                if (l instanceof c && (!n || !p))
                    if (j) {
                        if (l = l._getObjectsUnderPoint(a, b)) return this
                    } else {
                        if (l = l._getObjectsUnderPoint(a, b, g, d), !g && l) return l
                    } else
                if (!d || j || p)
                    if (l.getConcatenatedMatrix(h), n && (h.appendTransform(n.x, n.y, n.scaleX, n.scaleY, n.rotation, n.skewX, n.skewY, n.regX, n.regY), h.alpha = n.alpha),
                        e.globalAlpha = h.alpha, e.setTransform(h.a, h.b, h.c, h.d, h.tx - a, h.ty - b), (n || l).draw(e), this._testHit(e)) {
                        f.width = 0;
                        f.width = 1;
                        if (j) return this;
                        if (g) g.push(l);
...
(function() {
    ...
    b.initialize = function(a) {
        ...
        this.canvas = "string" ==
            typeof a ? document.getElementById(a) : a;
        this._pointerData = {};
    ...
    b.toDataURL = function(a, b) {
        ...
        a && (c.clearRect(0, 0, d, e), c.putImageData(f, 0, 0), c.globalCompositeOperation = h);
        return j
    };
    ...
    b._getPointerData = function(a) {
        ...
        b || (b = this._pointerData[a] = {
            x: 0,
            y: 0
        }, null == this._primaryPointerID && (this._primaryPointerID =
            a));
        return b
    };
    ...
    b._getElementRect = function(a) {
        ...
        var d = (window.pageXOffset || document.scrollLeft || 0) - (document.clientLeft || document.body.clientLeft || 0),
            e = (window.pageYOffset || document.scrollTop || 0) - (document.clientTop || document.body.clientTop ||
                0),
    ...
    b._handlePointerUp = function(a, b, c) {
        ...
        if ((f = d.target) && (f.onClick || f.hasEventListener("click")) && this._getObjectsUnderPoint(d.x,
            d.y, null, !0, this._mouseOverIntervalID ? 3 : 1) == f) e = new createjs.MouseEvent("click", d.x, d.y, f, b, a, a == this._primaryPointerID, d.rawX, d.rawY), f.onClick && f.onClick(e), f.dispatchEvent(e);
    ...
    b._handlePointerDown = function(a, b, c, d) {
        ...
        if (d = this._getObjectsUnderPoint(e.x, e.y, null, this._mouseOverIntervalID ? 3 : 1))
            if (e.target = d, d.onPress || d.hasEventListener("mousedown"))
                if (c = new createjs.MouseEvent("mousedown", e.x, e.y, d, b, a, a == this._primaryPointerID, e.rawX, e.rawY), d.onPress && d.onPress(c), d.dispatchEvent(c), c.onMouseMove || c.onMouseUp || c.hasEventListener("mousemove") || c.hasEventListener("mouseup")) e.event =
                    c
    };
...
(function() {
    ...
    b._normalizeFrame = function() {
        ...
        if (a)
            ...
            else d = this.spriteSheet.getNumFrames(), b >= d && !this._dispatchAnimationEnd(a, b, c, d - 1) && (this.currentFrame = 0)
    };
...
(function() {
    ...
    b._drawText = function(a) {
        ...
        for (var c = String(this.text).split(/(?:\r\n|\r|\n)/), d = this.lineHeight || this.getMeasuredLineHeight(), e = 0, f = 0, h = c.length; f <
            ...
            if (null == this.lineWidth || j < this.lineWidth) b && this._drawTextLine(a, c[f], e * d);
            else {
                for (var j = c[f].split(/(\s)/), k = j[0], l = 1, n = j.length; l < n; l += 2) a.measureText(k + j[l] + j[l + 1]).width > this.lineWidth ? (b && this._drawTextLine(a, k, e * d), e++, k = j[l + 1]) : k += j[l] + j[l + 1];
...
(function() {
    ...
    c._flip = function(b,
        a, m, g) {
        for (var d = b._images, e = c._workingCanvas, f = c._workingContext, h = d.length / a, j = 0; j < h; j++) {
            var k = d[j];
            k.__tmp = j;
            e.width = 0;
            e.width = k.width;
            e.height = k.height;
            f.setTransform(m ? -1 : 1, 0, 0, g ? -1 : 1, m ? k.width : 0, g ? k.height : 0);
            f.drawImage(k, 0, 0);
            var l = new Image;
        ...
        for (j = 0; j < e; j++) {
            ...
            m && (n.x = l.width - n.x - n.width, p.regX = n.width -
                k.regX);
            g && (n.y = l.height - n.y - n.height, p.regY = n.height - k.regY);
            f.push(p)
        }
        m = "_" + (m ? "h" : "") + (g ? "v" : "");
        g = b._animations;
...
(function() {
    ...
    b.addMovieClip = function(a, b, g) {
        ...
        if (a.length) {
            ...
            for (j = a.length; h < j; h++) {
                g = a[h].label;
                for (var d = b + (h == j - 1 ? f : a[h + 1].index), e = [], k = b + a[h].index; k < d; k++) e.push(k);
    ...
    b._startBuild = function() {
        ...
        for (var d = 0, e = 0, f = 0; g.length;) {
            ...
            d += h.h;
            if (!h.h || !g.length) {
                var j = createjs.createCanvas ? createjs.createCanvas() : document.createElement("canvas");
    ...
    b._fillRow = function(a, b, g, d, e) {
        ...
        for (var h = h - b, j = e, k = 0, l = a.length - 1; 0 <= l; l--) {
            ...
            t > h || j + q > f || (n.img = g, n.rect = new createjs.Rectangle(j, b, q, t), k = k || t, a.splice(l, 1), d[n.index] = [j, b, q, t, g, Math.round(-r + p * s.regX - e), Math.round(-u + p * s.regY - e)], j += q)
        }
        return {
            w: j,
            h: k
...
(function() {
    ...
    c._IE_handleEvent = function(b, a) {
        if (b) {
            ...
            if ("MSPointerDown" == c) a.srcElement == b.canvas && (d[g] = !0, this._handleStart(b, g, a, a.pageX, a.pageY));
            else if (d[g])
                if ("MSPointerMove" == c) this._handleMove(b, g, a, a.pageX, a.pageY);
                else
            if ("MSPointerUp" == c || "MSPointerCancel" == c) delete d[g], this._handleEnd(b, g, a)
        }
    };
