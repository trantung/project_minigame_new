...
function setupGame() {
    ...
    backgroundSound = h_moc1.play()//createjs.Sound.play("moc1");
...
function playBackgroundSound() {
    if (backgroundSoundOn) {
        if (level < 6) backgroundSound = h_moc1.play()//createjs.Sound.play("moc1");
        else if (level > 10) backgroundSound = h_moc3.play()//createjs.Sound.play("moc3");
        else backgroundSound = h_moc2.play()//createjs.Sound.play("moc2");
