...
<meta name="Description" content="zombie">
<title>Cuộc chiến Zombie</title>
<style type="text/css">
...
<link rel='canonical' href='http://choinhanh.vn/chien-thuat/cuoc-chien-zombie'/>
</head>
...
<div id="dSurface" class="WindowFrame" style="display:none;z-index:255;left:0">
	<div id="iSurfaceBackground">
		...
		<div style="position: absolute;background:url('images/SelectorScreenChallenges.png');left:478px;top:303px;width:286px;height:122px;cursor:pointer" onMouseOver="this.style.backgroundPosition='bottom'" onMouseOut="this.style.backgroundPosition='top'" onClick="ShowRiddleGame()"></div>
	</div>
	<div id="dSurfaceBack">
		...
		<div id="dOptionsMenuback">
			<div id="dOptionsMenu" style="line-height:40px;position:absolute;width:100%;height:100%;display:none;font-weight:bold">
				<div style="margin-top:150px;height:40px"><input type="checkbox" id="cAutoSun" value="1" onChange="CheckAutoSun(this)"><label for="cAutoSun" id="lAutoSun" style="color:#FFF">Tự động nhận ánh sáng</label></div>
				<div class="BigLevel" style="cursor:pointer" onClick="SelectModal(oS.Lvl)">Khởi động lại</div>
				<div class="BigLevel" style="cursor:pointer" onClick="HiddenOptions();SelectModal(0);SetBlock($('dSurface'),$('iSurfaceBackground'))">Trở lại menu</div>
				<div class="OptionsMenuButton" style="margin-top:108px" onMouseDown="OptionsMenuDown(this,$('sOptionsMenu'))" onMouseUp="OptionsMenuUP(this,$('sOptionsMenu'));HiddenOptions()"><span id="sOptionsMenu" class="OptionsMenuButtonSpan">Lưu trò chơi</span></div>
			</div>
			<div id="dSelectLevel">
				<div class="TitleBigContainer">
					<div id="dTitleSmallContainer" class="TitleSmallContainer" style="display:none">
						<div id="dBigLvl1">
							<div class="BigLevel">&nbsp;&nbsp;&nbsp;Đánh đấu đầu tiên&nbsp;&nbsp;&nbsp;<span style="cursor:pointer" onClick="SetNone($('dBigLvl1'));SetBlock($('dBigLvl2'))" title="Zombie">>></span></div>
							<div onClick="SelectModal(1)" class="SmallLevel">Bàn 1</div>
							<div onClick="SelectModal(2)" class="SmallLevel">Bàn 2</div>
							<div onClick="SelectModal(3)" class="SmallLevel">Bàn 3</div>
							<div onClick="SelectModal(4)" class="SmallLevel">Bàn 4</div>
							<div onClick="SelectModal(5)" class="SmallLevel">Bàn 5</div>
							<div onClick="SelectModal(6)" class="SmallLevel">Bàn 6</div>
							<div onClick="SelectModal(7)" class="SmallLevel">Bàn 7</div>
							<div onClick="SelectModal(8)" class="SmallLevel">Bàn 8</div>
							<div onClick="SelectModal(9)" class="SmallLevel">Bàn 9</div>
							<div onClick="SelectModal(10)" class="SmallLevel">Bàn 10</div>
						</div>
						<div id="dBigLvl2" style="display:none">
							<div class="BigLevel"><span style="cursor:pointer" onClick="SetNone($('dBigLvl2'));SetBlock($('dBigLvl1'))" title="点击进入到第一大关"><<</span>&nbsp;&nbsp;&nbsp;Nhãn hiệu thứ hai&nbsp;&nbsp;&nbsp;</div>
							<div onClick="SelectModal(11)" class="SmallLevel">Đầu tiên</div>
							<div onClick="SelectModal(12)" class="SmallLevel">Thứ hai</div>
							<div onClick="SelectModal(13)" class="SmallLevel">Thứ ba</div>
						</div>
					</div>
					<div id="dMiniSmallContainer" class="TitleSmallContainer" style="display:none">
						<div class="BigLevel">Chế độ chơi nhỏ</div>
						<div onClick="SelectModal('StrongLevel')" class="SmallLevel" style="width:100%">Áp lực phi thường！</div>
						<div onClick="SelectModal('TestUHeart')" class="SmallLevel" style="width:100%">Trái tim của bạn đủ làm？</div>
						<div onClick="SelectModal('ZombieRun')" class="SmallLevel" style="width:100%">Chạy Zombie！</div>
						<div onClick="SelectModal('PovertyOfTheSoil')" class="SmallLevel" style="width:100%">Hoàn cảnh khó khăn</div>
						<div onClick="SelectModal('MassGrave')" class="SmallLevel" style="width:100%">Ngôi mộ tập thể</div>
						<div onClick="SelectModal('DependOnHeavenForFood')" class="SmallLevel" style="width:100%">Phụ thuộc</div>
					</div>
					<div id="dRiddleSmallContainer" class="TitleSmallContainer" style="display:none">
						<div class="BigLevel">Chế độ câu đố</div>
						<div onClick="SelectModal('ImZombie1')" class="SmallLevel" style="width:100%">Tôi là một zombie！</div>
					</div>
				</div>
				<div class="OptionsMenuButton" style="margin-top:20px" onMouseDown="OptionsMenuDown(this,$('sLevelMenu'))" onMouseUp="OptionsMenuUP(this,$('sLevelMenu'));HiddenLevel();HiddenMiniGame();HiddenRiddleGame();"><span id="sLevelMenu" class="OptionsMenuButtonSpan">Quay trở lại&nbsp;&nbsp;&nbsp;&nbsp;回</span></div>
			</div>
		</div>
	</div>
</div>
...
<!--主界面EDAll-->
<div class="WindowFrame" id="dAll" style="position:absolute;top:0;width:900px;background-color:#000">
	<!--背景图片-->
	...
	<div id="dSelectCard" align=center style="display:none;position:absolute;left:600px;top:0;width:465px;height:600px;z-index:1;background: url('images/interface/SeedChooser_Background.png') no-repeat">
		<div style="text-align:center;line-height:35px;font-size: 12pt;color:#FC6;height:35px;width:100%;top:0;font-family:新宋体;font-weight: bold">Lựa chọn cây cho bạn</div>
...
<div id="dMenu" style="display:none;position:absolute;cursor:pointer;width:226px;height:41px;left:677px;z-index:254">
	<div id="dMenu0" class="Menu" onClick="PauseGame(this)">Tạm dừng</div>
...
<table border="0" width="800" cellspacing="0" cellpadding="0" background="images/interface/Almanac_IndexBack.jpg" height="600">
	<tr>
		<td height="88" align="center" style="font-size: 32px; font-weight: bold; font-family: 黑体;" colspan="3">	Minh họa chỉ số</td>
	</tr>
	<tr>
...
&nbsp;<table border="0" width="113" background="images/interface/Button.png" height="41" cellspacing="0" cellpadding="0">
			<tr>
				<td style="cursor:pointer;font-weight:bold; font-size:14pt; font-family:幼圆; color:#00F500" align="center" onClick="ViewProduceZombie()">Xem zombie</td>
			</tr>
		</table>
		<p><br>
		<br>
	...
	<tr>
		...
		<table border="0" width="89" cellspacing="0" cellpadding="0" height="26">
			<tr>
				...
				<font color="#000080" style="font-size: 9pt;"Đóng</font></td>
			</tr>
		</table>
		</td>
	</tr>
...
<div id="dNewPlant" style="display:none;position:absolute;width:800px;height:600px;background:url(images/interface/AwardScreen_Back.jpg) no-repeat">
	<div id="dNewPlantTitle" style="position:absolute;left:50%;text-align:center;margin-left:-250px;color: #FC6; font-size: 20px;height:90px;line-height:90px; font-weight: bold; width:500px">Bạn sẽ có thực vật mới！</div>
	...
	<br><br><br><br><br><br>
	<input type="button" value="Level！" name="btnNextLevel" id="btnNextLevel" style="position:absolute;cursor:pointer;width: 113; height: 41; border-left: 3px solid #85411C; border-right: 3px solid #4E250C; border-top: 3px solid #85411C; border-bottom: 3px solid #4E250C; background-color: #8F431B; color:#FC6; font-weight:bold; font-size:14px; font-family:幼圆; left:344; top:507">
</div>
...
<div id="dProcess">
	...
	<br>
	<input type="button" value="Đóng" onClick="SetNone($('dProcess'))" style="cursor:pointer;width: 113px; height: 30px; border-left: 3px solid #85411C; border-right: 3px solid #4E250C; border-top: 3px solid #85411C; border-bottom: 3px solid #4E250C; background-color: #8F431B; color:#FC6; font-weight:bold; font-size:14px; font-family:幼圆">
</div>
...
<div id="dLink">
	...
	document.write('<div><script src="http://s9.cnzz.com/stat.php?id=2462431&web_id=2462431&show=pic"></scri'+'pt></div>');</script>
</div>
...
if($User.HTTP){
	var _gaq=_gaq||[];
	_gaq.push(['_setAccount', 'UA-18730911-1']);
